    ...
    <div className="min-h-screen home-watch-banner">
      <div className="home-watch-overly">
        <div className="home-watch-content">
          ...
          <p>A watch is very important to be punctual. If you use a watch you look smart and professional. Both men and women should use watch to be more professional.</p>
